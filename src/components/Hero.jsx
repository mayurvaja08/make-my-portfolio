...
<div
      ...
      ><input
        ...
        />
              ...
              <img src={process.env.PUBLIC_URL+'/assets/profile_pic.jpg'} alt="profile" className="w-36 h-36 rounded-full object-cover mx-auto border-2 border-solid border-[#122033]" />
